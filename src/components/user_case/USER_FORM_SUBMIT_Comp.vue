<template>
  <div>
    <light7-modal v-if="this.is_start" button_text="阅读完毕" @receive_from_child="modal_return" :info="start_info" :default_show="noti_show">
    </light7-modal>
...
<script>
  ...
  export default {
    ...
    data: function() {
      return {
        start_info: {},
        post_url: '/api/user_view/case/user_form_submit',
        FId: 'submit_form',
        detail: {},
        noti_show:false
      };
